...
# model = keras.models.load_model('3_words.h5')
model = keras.models.load_model('bsl_word_level_1.h5')
...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
    ...
    while True:
        ...
        if results.pose_landmarks is not None:
            ...
            # Reshape and preprocess the keypoints
            keypoints = np.array(keypoints)
            keypoints = keypoints.reshape(1, 30, -1)
